...
public class CategoriaResources {
    ...
    public ModelAndView novo(Model model, Categoria categoria) { // tem que haver no método para ele mapear depois
        ...
        final ModelAndView mv = new ModelAndView("categoria/Categoria");
    ...
    public ModelAndView lista(Model model) {
		...
		final List<Categoria> categorias = categoriaServices.seleciona(usuario);
		final ModelAndView mv = new ModelAndView("categoria/Listagem");
